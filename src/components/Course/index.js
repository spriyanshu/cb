                ...
                <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                    <div className="flex flex-col justify-between lg:py-5">
                        ...
                        <div className="mt-auto">
                            ...
                            <div className="flex items-center mt-8">
                                <img className="flex-shrink-0 object-cover w-10 h-10 rounded-full" src="https://cdn.rareblocks.xyz/collection/celebration/images/pricing/2/avatar.jpg" alt="" />
                                <div className="ml-4">
                                    <p className="text-base font-semibold text-gray-800">Brooklyn Simmons</p>
                    ...
                    <div>
                        <div className="overflow-hidden bg-white rounded-md">
                            <div className="p-10">
                                <h3 className="text-xs font-semibold tracking-widest text-purple-600 uppercase">Single pack</h3>
                                ...
                                <div className="flex items-center mt-5">
                                    ...
                                    <span className="ml-2 text-sm text-gray-500"> 14 Days Moneyback Guarantee </span>
                                </div>
                            </div>
                        </div>
                    </div>
