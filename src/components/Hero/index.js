            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        <h1 className="mt-4  text-6xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-8xl">Data Science Internship <span className="text-red-600">Program</span>.</h1>
                        <p className="mt-4 text-base text-black lg:mt-8 sm:text-xl">A 100% job 🎯ready Program🚀</p>
                    </div>
