        ...
        <div className="relative font-sans">
            <nav className="relative  px-4 sm:px-2 md:px-2 lg:px-8 xl:px-24 2xl:px-64 py-3 sm:py-2 md:py-4 lg:py-4 xl:py-6 2xl:py-6 flex justify-between items-center bg-[#FCF8F1] bg-opacity-30">
                ...
                <div className="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                    ...
                    <Link to="https://chat.whatsapp.com/DqGuCJmpR5J34LFIaskpSh" target='_blank' className="hidden lg:inline-flex items-center justify-center px-5 py-2.5 text-base transition-all duration-200 hover:bg-yellow-300 hover:text-black focus:text-black focus:bg-yellow-300 font-semibold text-white bg-black rounded-full" role="button">Join Now</Link>
                </div>
